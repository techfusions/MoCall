...
class PreparednessPlan extends StatefulWidget {
  const PreparednessPlan({super.key});

  @override
  State<PreparednessPlan> createState() => _PreparednessPlanState();
}

class _PreparednessPlanState extends State<PreparednessPlan> {
  //double? _progress;
  final DatabaseReference _databaseRef =
      FirebaseDatabase.instance.ref().child('GuidelinesKit');
