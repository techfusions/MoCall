...
class PortalViews extends StatefulWidget {
  const PortalViews(
      {super.key,
      required this.keys,
  ...
  final String image;
  @override
  State<PortalViews> createState() => _ResponseRecordViewState();
}

class _ResponseRecordViewState extends State<PortalViews> {
